<%@ page import="czy.cookie.util.CookieUtil" %><%--
...
<div class="row" style="width:1210px;margin:0 auto;">
    ...
    <div class="col-md-2">
        ...
        <p><a href="/getProductById!id=1" style='color:green'>女士外套</a></p>
    ...
    <div class="col-md-2">
        ...
        <p><font color="#FF0000">商城价：&yen;499.00</font></p>
    </div>
    ...
    <div class="col-md-2">
        ...
        <p><font color="#FF0000">商城价：&yen;699.00</font></p>
    </div>
    ...
    <div class="col-md-2">
        ...
        <p><a href="/getProductById?id=4" style='color:green'>女士短裙</a></p>
...
<div style="width:1210px;margin:0 auto; padding: 0 9px;border: 1px solid #ddd;border-top: 2px solid #999;height: 246px;">
    ...
    <h4 style="width: 50%;float: left;font: 14px/30px " 微软雅黑 ";">浏览记录<small><a href="/clear">清空记录</a> </small></h4>
